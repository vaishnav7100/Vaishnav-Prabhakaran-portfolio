...
const LOCATIONS = [
  // Kerala
  { name:"Alappuzha",    state:"Kerala",      slug:"alappuzha",    lat:"9.4981",  lng:"76.3388" },
  { name:"Ernakulam",    state:"Kerala",      slug:"ernakulam",    lat:"9.9816",  lng:"76.2999" },
  { name:"Idukki",       state:"Kerala",      slug:"idukki",       lat:"9.8440",  lng:"77.1025" },
  { name:"Kannur",       state:"Kerala",      slug:"kannur",       lat:"11.8745", lng:"75.3704" },
  { name:"Kasaragod",    state:"Kerala",      slug:"kasaragod",    lat:"12.4996", lng:"74.9869" },
  { name:"Kollam",       state:"Kerala",      slug:"kollam",       lat:"8.8932",  lng:"76.6141" },
  { name:"Kottayam",     state:"Kerala",      slug:"kottayam",     lat:"9.5916",  lng:"76.5222" },
  { name:"Kozhikode",    state:"Kerala",      slug:"kozhikode",    lat:"11.2588", lng:"75.7804" },
  { name:"Malappuram",   state:"Kerala",      slug:"malappuram",   lat:"11.0730", lng:"76.0740" },
  { name:"Palakkad",     state:"Kerala",      slug:"palakkad",     lat:"10.7867", lng:"76.6548" },
  { name:"Pathanamthitta",state:"Kerala",     slug:"pathanamthitta",lat:"9.2648", lng:"76.7870" },
  { name:"Thiruvananthapuram",state:"Kerala", slug:"thiruvananthapuram",lat:"8.5241",lng:"76.9366" },
  { name:"Thrissur",     state:"Kerala",      slug:"thrissur",     lat:"10.5276", lng:"76.2144" },
  { name:"Wayanad",      state:"Kerala",      slug:"wayanad",      lat:"11.6854", lng:"76.1320" },
  { name:"Kochi",        state:"Kerala",      slug:"kochi",        lat:"9.9312",  lng:"76.2673" },
  { name:"Trivandrum",   state:"Kerala",      slug:"trivandrum",   lat:"8.5241",  lng:"76.9366" },
  { name:"Calicut",      state:"Kerala",      slug:"calicut",      lat:"11.2588", lng:"75.7804" },
  { name:"Alleppey",     state:"Kerala",      slug:"alleppey",     lat:"9.4981",  lng:"76.3388" },
  { name:"Munnar",       state:"Kerala",      slug:"munnar",       lat:"10.0889", lng:"77.0595" },
  { name:"Varkala",      state:"Kerala",      slug:"varkala",      lat:"8.7342",  lng:"76.7160" },
  { name:"Guruvayur",    state:"Kerala",      slug:"guruvayur",    lat:"10.5942", lng:"76.0387" },
  { name:"Thalassery",   state:"Kerala",      slug:"thalassery",   lat:"11.7519", lng:"75.4928" },
  { name:"Ponnani",      state:"Kerala",      slug:"ponnani",      lat:"10.7738", lng:"75.9260" },
  { name:"Vatakara",     state:"Kerala",      slug:"vatakara",     lat:"11.6005", lng:"75.5913" },
  { name:"Kanhangad",    state:"Kerala",      slug:"kanhangad",    lat:"12.3167", lng:"75.0960" },
  { name:"Payyanur",     state:"Kerala",      slug:"payyanur",     lat:"12.0973", lng:"75.2028" },
  { name:"Koyilandy",    state:"Kerala",      slug:"koyilandy",    lat:"11.4359", lng:"75.7048" },
  { name:"Neyyattinkara",state:"Kerala",      slug:"neyyattinkara",lat:"8.3991",  lng:"77.0848" },
  { name:"Manjeri",      state:"Kerala",      slug:"manjeri",      lat:"11.1190", lng:"76.1201" },
  { name:"Nedumangad",   state:"Kerala",      slug:"nedumangad",   lat:"8.6012",  lng:"77.0049" },
  { name:"Tirur",        state:"Kerala",      slug:"tirur",        lat:"10.9138", lng:"75.9225" },
  { name:"Punalur",      state:"Kerala",      slug:"punalur",      lat:"9.0098",  lng:"76.9213" },
  { name:"Muvattupuzha", state:"Kerala",      slug:"muvattupuzha", lat:"9.9859",  lng:"76.5793" },
  { name:"Chengannur",   state:"Kerala",      slug:"chengannur",   lat:"9.3167",  lng:"76.6167" },
  { name:"Changanassery",state:"Kerala",      slug:"changanassery",lat:"9.4449",  lng:"76.5367" },
  { name:"Thodupuzha",   state:"Kerala",      slug:"thodupuzha",   lat:"9.8998",  lng:"76.7179" },
  { name:"Chalakudy",    state:"Kerala",      slug:"chalakudy",    lat:"10.3007", lng:"76.3313" },
  { name:"Kodungallur",  state:"Kerala",      slug:"kodungallur",  lat:"10.2333", lng:"76.2020" },
  { name:"Perinthalmanna",state:"Kerala",     slug:"perinthalmanna",lat:"10.9789",lng:"76.2267" },
  { name:"Kottarakkara", state:"Kerala",      slug:"kottarakkara", lat:"9.0024",  lng:"76.7786" },
  { name:"Nilambur",     state:"Kerala",      slug:"nilambur",     lat:"11.2782", lng:"76.2214" },
  { name:"Attingal",     state:"Kerala",      slug:"attingal",     lat:"8.6944",  lng:"76.8136" },
  { name:"Mattannur",    state:"Kerala",      slug:"mattannur",    lat:"11.9275", lng:"75.5725" },
  { name:"Sultan Bathery",state:"Kerala",     slug:"sultan-bathery",lat:"11.6480",lng:"76.2591" },
  { name:"Kalpetta",     state:"Kerala",      slug:"kalpetta",     lat:"11.6083", lng:"76.0825" },
  { name:"Mananthavady", state:"Kerala",      slug:"mananthavady", lat:"11.8002", lng:"76.0023" },
  // Karnataka
  { name:"Bangalore",    state:"Karnataka",   slug:"bangalore",    lat:"12.9716", lng:"77.5946" },
  { name:"Bengaluru",    state:"Karnataka",   slug:"bengaluru",    lat:"12.9716", lng:"77.5946" },
  { name:"Mysore",       state:"Karnataka",   slug:"mysore",       lat:"12.2958", lng:"76.6394" },
  { name:"Mysuru",       state:"Karnataka",   slug:"mysuru",       lat:"12.2958", lng:"76.6394" },
  { name:"Mangalore",    state:"Karnataka",   slug:"mangalore",    lat:"12.9141", lng:"74.8560" },
  { name:"Mangaluru",    state:"Karnataka",   slug:"mangaluru",    lat:"12.9141", lng:"74.8560" },
  { name:"Hubli",        state:"Karnataka",   slug:"hubli",        lat:"15.3647", lng:"75.1240" },
  { name:"Dharwad",      state:"Karnataka",   slug:"dharwad",      lat:"15.4589", lng:"75.0078" },
  { name:"Belgaum",      state:"Karnataka",   slug:"belgaum",      lat:"15.8497", lng:"74.4977" },
  { name:"Belagavi",     state:"Karnataka",   slug:"belagavi",     lat:"15.8497", lng:"74.4977" },
  { name:"Gulbarga",     state:"Karnataka",   slug:"gulbarga",     lat:"17.3297", lng:"76.8343" },
  { name:"Kalaburagi",   state:"Karnataka",   slug:"kalaburagi",   lat:"17.3297", lng:"76.8343" },
  { name:"Shimoga",      state:"Karnataka",   slug:"shimoga",      lat:"13.9299", lng:"75.5681" },
  { name:"Shivamogga",   state:"Karnataka",   slug:"shivamogga",   lat:"13.9299", lng:"75.5681" },
  { name:"Davangere",    state:"Karnataka",   slug:"davangere",    lat:"14.4644", lng:"75.9218" },
  { name:"Bellary",      state:"Karnataka",   slug:"bellary",      lat:"15.1394", lng:"76.9214" },
  { name:"Ballari",      state:"Karnataka",   slug:"ballari",      lat:"15.1394", lng:"76.9214" },
  { name:"Udupi",        state:"Karnataka",   slug:"udupi",        lat:"13.3409", lng:"74.7421" },
  { name:"Hassan",       state:"Karnataka",   slug:"hassan",       lat:"13.0068", lng:"76.1004" },
  { name:"Tumkur",       state:"Karnataka",   slug:"tumkur",       lat:"13.3379", lng:"77.1007" },
  { name:"Tumakuru",     state:"Karnataka",   slug:"tumakuru",     lat:"13.3379", lng:"77.1007" },
  { name:"Mandya",       state:"Karnataka",   slug:"mandya",       lat:"12.5218", lng:"76.8951" },
  { name:"Raichur",      state:"Karnataka",   slug:"raichur",      lat:"16.2120", lng:"77.3439" },
  { name:"Bidar",        state:"Karnataka",   slug:"bidar",        lat:"17.9104", lng:"77.5199" },
  { name:"Bagalkot",     state:"Karnataka",   slug:"bagalkot",     lat:"16.1691", lng:"75.6961" },
  { name:"Chikmagalur",  state:"Karnataka",   slug:"chikmagalur",  lat:"13.3153", lng:"75.7754" },
  { name:"Gadag",        state:"Karnataka",   slug:"gadag",        lat:"15.4167", lng:"75.6333" },
  // Tamil Nadu
  { name:"Chennai",      state:"Tamil Nadu",  slug:"chennai",      lat:"13.0827", lng:"80.2707" },
  { name:"Coimbatore",   state:"Tamil Nadu",  slug:"coimbatore",   lat:"11.0168", lng:"76.9558" },
  { name:"Madurai",      state:"Tamil Nadu",  slug:"madurai",      lat:"9.9252",  lng:"78.1198" },
  { name:"Tiruchirappalli",state:"Tamil Nadu",slug:"tiruchirappalli",lat:"10.7905",lng:"78.7047" },
  { name:"Trichy",       state:"Tamil Nadu",  slug:"trichy",       lat:"10.7905", lng:"78.7047" },
  { name:"Salem",        state:"Tamil Nadu",  slug:"salem",        lat:"11.6643", lng:"78.1460" },
  { name:"Tirunelveli",  state:"Tamil Nadu",  slug:"tirunelveli",  lat:"8.7139",  lng:"77.7567" },
  { name:"Erode",        state:"Tamil Nadu",  slug:"erode",        lat:"11.3410", lng:"77.7172" },
  { name:"Vellore",      state:"Tamil Nadu",  slug:"vellore",      lat:"12.9165", lng:"79.1325" },
  { name:"Thoothukudi",  state:"Tamil Nadu",  slug:"thoothukudi",  lat:"8.7642",  lng:"78.1348" },
  { name:"Tuticorin",    state:"Tamil Nadu",  slug:"tuticorin",    lat:"8.7642",  lng:"78.1348" },
  { name:"Thanjavur",    state:"Tamil Nadu",  slug:"thanjavur",    lat:"10.7870", lng:"79.1378" },
  { name:"Dindigul",     state:"Tamil Nadu",  slug:"dindigul",     lat:"10.3624", lng:"77.9695" },
  { name:"Hosur",        state:"Tamil Nadu",  slug:"hosur",        lat:"12.7409", lng:"77.8253" },
  { name:"Nagercoil",    state:"Tamil Nadu",  slug:"nagercoil",    lat:"8.1833",  lng:"77.4119" },
  { name:"Tiruppur",     state:"Tamil Nadu",  slug:"tiruppur",     lat:"11.1085", lng:"77.3411" },
  { name:"Kanchipuram",  state:"Tamil Nadu",  slug:"kanchipuram",  lat:"12.8352", lng:"79.7036" },
  { name:"Cuddalore",    state:"Tamil Nadu",  slug:"cuddalore",    lat:"11.7804", lng:"79.7676" },
...
const SEO_FOOTER = `
          <!-- Kerala -->
          <a href="/art/locations/kannur.html">Portrait Artist in Kannur</a> &middot;
          <a href="/art/locations/kochi.html">Portrait Artist in Kochi</a> &middot;
          <a href="/art/locations/kozhikode.html">Portrait Artist in Kozhikode</a> &middot;
          <a href="/art/locations/thiruvananthapuram.html">Portrait Artist in Thiruvananthapuram</a> &middot;
          <a href="/art/locations/thrissur.html">Portrait Artist in Thrissur</a> &middot;
          <a href="/art/locations/malappuram.html">Portrait Artist in Malappuram</a> &middot;
          <a href="/art/locations/palakkad.html">Pencil Sketch Palakkad</a> &middot;
          <a href="/art/locations/kasaragod.html">Portrait Commission Kasaragod</a> &middot;
          <a href="/art/locations/kollam.html">Charcoal Portrait Kollam</a> &middot;
          <a href="/art/locations/kottayam.html">Custom Portrait Kottayam</a> &middot;
          <a href="/art/locations/bangalore.html">Portrait Artist Bangalore</a> &middot;
          <a href="/art/locations/mysore.html">Pencil Sketch Mysore</a> &middot;
          <a href="/art/locations/mangalore.html">Charcoal Drawing Mangalore</a> &middot;
...
function generate(loc) {
  ...
  const keywords = [
    ...
    `custom portrait ${name}`, `custom sketch ${name}`, `pencil drawing ${name}`,
    `hyper realistic portrait ${name}`, `portrait commission ${name}`,
...
<body data-theme="dark">
  ...
  <!-- Cursor glow -->
  <div class="art-cursor-glow" id="artCursorGlow"></div>

  <!-- ═══ NAVBAR ═══ -->
  <nav class="art-nav" id="artNav">
    <div class="art-nav-inner">
      <a href="/art/" class="art-nav-logo">
        <span class="art-logo-mark">_V_P</span><span class="art-logo-arts">_ARTS</span><span class="art-logo-dot">.</span>
      </a>
      <div class="art-nav-links" id="artNavLinks">
        <a href="/art/#gallery" class="art-nav-link">Gallery</a>
        <a href="/art/#pricing" class="art-nav-link">Pricing</a>
        <a href="/art/#calculator" class="art-nav-link">Calculator</a>
        <a href="/art/#process" class="art-nav-link">Process</a>
      </div>
      <div class="art-nav-right">
        <button class="art-theme-btn" id="artThemeBtn" aria-label="Toggle theme">
          <i class="fas fa-sun icon-sun"></i>
          <i class="fas fa-moon icon-moon"></i>
        </button>
        <a href="https://wa.me/918078461246?text=Hi!%20I%27m%20from%20${encodeURIComponent(name)}%20and%20interested%20in%20a%20custom%20portrait." target="_blank" rel="noopener" class="art-nav-cta" id="artNavCTA">
          <i class="fab fa-whatsapp"></i> Order Now
        </a>
        <button class="art-hamburger" id="artMenuBtn" aria-label="Open menu">
  ...
  <!-- Mobile Menu -->
  <div class="art-mobile-menu" id="artMobileMenu" aria-hidden="true">
    <div class="art-mobile-inner">
      <div class="art-mobile-top">
        <span class="art-logo-mark" style="font-weight:800;font-size:1.1rem">_V_P_ARTS</span>
        <button class="art-mobile-close" id="artMenuClose"><i class="fas fa-times"></i></button>
      </div>
      <nav class="art-mobile-nav">
        <a href="/art/#gallery" class="art-mobile-link">Gallery</a>
        <a href="/art/#pricing" class="art-mobile-link">Pricing</a>
        <a href="/art/#calculator" class="art-mobile-link">Calculator</a>
        <a href="/art/#process" class="art-mobile-link">Process</a>
      </nav>
      <a href="https://wa.me/918078461246?text=Hi!%20I%27m%20from%20${encodeURIComponent(name)}%20and%20interested%20in%20a%20custom%20portrait." target="_blank" rel="noopener" class="art-mobile-cta">
  ...
  <!-- Hero -->
  <section class="art-hero" id="home">
  ...
  <!-- Scrolling ticker -->
  <div class="art-ticker-wrap" aria-hidden="true">
    ...
    <div class="art-container">
      ...
      <div class="art-gift-grid reveal-up" style="--delay:0.06s">
        ...
        <div class="art-gift-card">
          ...
          <h3>Anniversary Gift</h3>
          <p>Commission a couple portrait for anniversaries, weddings, or Valentine&apos;s Day. Delivered to ${name}, ${state}.</p>
        </div>
        <div class="art-gift-card">
      ...
      <div class="art-pricing-grid">
        <!-- A5 Card -->
        <div class="art-price-card reveal-up" style="--delay:0.04s">
          <div class="art-price-badge">A5 Size</div>
          ...
          <a href="/art/#calculator" class="art-price-cta">Calculate My Price</a>
        </div>

        <!-- A4 Card -->
        <div class="art-price-card reveal-up" style="--delay:0.08s">
          <div class="art-price-badge">A4 Size</div>
        ...
        <!-- A3 Card -->
        <div class="art-price-card art-price-card--feat reveal-up" style="--delay:0.14s">
          <div class="art-sheen"></div>
          <div class="art-price-badge art-price-badge--feat">A3 &#183; Best Value</div>
          ...
          <a href="/art/#calculator" class="art-price-cta art-price-cta--feat">Calculate My Price</a>
        </div>
      </div>
      ...
      <section class="art-section" id="about">
        <div class="art-container">
          <div class="art-about-box reveal-up">
            <div class="art-about-img">
              <img src="../../vaishnav.jpg" alt="Vaishnav Prabhakaran" loading="lazy" />
              <div class="art-about-glow"></div>
            </div>
      ...
      <!-- CTA -->
      <div class="art-cta-section reveal-up" style="--delay:0.08s; padding-block:72px 0">
    ...
    <div class="art-container">
      <div class="art-footer-top">
        ...
        <nav class="art-footer-nav">
          <a href="/art/">Home</a>
          <a href="/art/#gallery">Gallery</a>
          <a href="/art/#pricing">Pricing</a>
          <a href="/art/#calculator">Calculator</a>
          <a href="/">Tech Portfolio</a>
        </nav>
        <div class="art-footer-socials">
          <a href="https://instagram.com/vaishnv7100" target="_blank" rel="noopener" aria-label="Instagram"><i class="fab fa-instagram"></i></a>
          <a href="https://wa.me/918078461246" target="_blank" rel="noopener" aria-label="WhatsApp"><i class="fab fa-whatsapp"></i></a>
        </div>
      </div>
...
for (const loc of LOCATIONS) {
  const html = generate(loc);
  const outPath = path.join(OUTPUT_DIR, `${loc.slug}.html`);
  fs.writeFileSync(outPath, html, "utf8");
  count++;
}
console.log(`Generated ${count} art location pages in ${OUTPUT_DIR}`);
